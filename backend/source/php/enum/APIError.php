...
class APIError
{
    ...
    public const PARAMETER_EXISTS = "PARAMETER_EXISTS";

    public const PARAMETER_DUPLICATE = "PARAMETER_DUPLICATE";

    public const PARAMETER_INVALID = "PARAMETER_INVALID";

    public const PARAMATER_FILE_NOT_SUPPORTED = "PARAMATER_FILE_NOT_SUPPORTED";
    public const PARAMETER_FILE_TOO_LARGE = "PARAMETER_FILE_TOO_LARGE";
